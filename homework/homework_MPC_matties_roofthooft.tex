...
\begin{figure}[ht!]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \label{subfig:N_10_clipping_false}
    \end{subfigure}
    \vspace{1em} % Adds a small vertical space between the subfigure
    % --- Second Subfigure ---
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \label{subfig:N_10_clipping_true}
    \end{subfigure}
    \caption{MHE with prior filtering for an horizon of 10.}
    \label{fig:MHE_prior_N10}
\end{figure}
...
\begin{figure}[ht!]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{Without clipping}
        \label{subfig:N_25_clipping_false}
    \end{subfigure}
    \vspace{1em} % Adds a small vertical space between the subfigure
    % --- Second Subfigure ---
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{With clipping}
        \label{subfig:N_25_clipping_true}
    \end{subfigure}
    \caption{MHE with prior filtering for an horizon of 25.}
